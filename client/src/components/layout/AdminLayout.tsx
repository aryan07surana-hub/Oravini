...
import {
  ...
  LogOut, ChevronRight, Menu, X, BookOpen, Video, Zap, Database, ClipboardList, Users2, CalendarDays, Mail, TrendingDown, Gift, Star, Activity
} from "lucide-react";
...
const mainNavItems = [
  ...
  { href: "/admin/tool-heatmap", label: "Tool Heatmap", icon: Activity },
