...
import {
  ...
  LogOut, ChevronRight, Menu, X, CalendarPlus, BarChart2, Sparkles, Users, Bot, Clapperboard, Zap, Layers, Settings, ArrowUpRight, TrendingUp, Wand2, ScanSearch, MessageCircle, Wrench, Mic, Film, Scissors
} from "lucide-react";
