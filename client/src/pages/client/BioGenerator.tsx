        ...
        <div className="max-w-3xl mx-auto px-5 py-8">
          ...
          <div className="flex items-center gap-3 mb-7">
            ...
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: "rgba(212,180,97,0.12)", border: "1px solid rgba(212,180,97,0.2)" }}>
              <User className="w-4 h-4" style={{ color: "#d4b461" }} />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white">Bio Generator</h1>
              <p className="text-xs text-muted-foreground">AI writes your bio using the 4-line framework — attract/repel, social proof, CTA, link</p>
            </div>
          </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    data-testid="input-who-you-help"
                  />
                </div>
              </div>
            </div>
