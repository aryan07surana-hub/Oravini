...
export default function VideoClipEditor() {
  ...
  const autoCaption = async () => {
    ...
    try {
      ...
      const words: { word: string; start: number; end: number }[] = data.words || [];
      if (!words.length) { toast({ title: "No speech detected" }); return; }

      // Group into 4-word chunks
      const chunkSize = 4;
            ...
            <div className="flex-1 p-3 space-y-3 overflow-y-auto text-xs">
              ...
              {activeTool === "ai" && (
                <div className="space-y-2.5">
                  <p className="text-zinc-500">Select a clip, then run AI tools on it.</p>
                  {selectedClip && (
                    <>
                      <button onClick={autoCaption} disabled={isCaptioning || !selectedClip.filePath}
                        ...
                        <div className="text-left">
                          <p className="font-semibold">Auto Captions</p>
                          <p className="text-[9px] text-zinc-500">Whisper AI word-level captions</p>
                        </div>
                      </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div data-notimeline data-trimhandle
                        className="absolute left-0 top-0 bottom-0 w-2.5 bg-primary/80 cursor-ew-resize z-10 flex items-center justify-center"
                      ...
                      <div data-notimeline data-trimhandle
                        className="absolute right-0 top-0 bottom-0 w-2.5 bg-primary/80 cursor-ew-resize z-10 flex items-center justify-center"
